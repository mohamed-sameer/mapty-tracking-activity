...
// create subclasses for running adn cycling
...
class App {
  ...
  constructor() {
    ...
    // this keyword is pointing to form , now we need ti make it point to class using bind
    form.addEventListener('submit', this._newWorkout.bind(this));
    // change form input type on change
    inputType.addEventListener('change', this._toggleElevationField);
    // move to current activity
    containerWorkouts.addEventListener('click', this._moveToPopup.bind(this));
  }
  _getPosition() {
    if (navigator.geolocation)
      // this._loadMap is called as a regular function we need to bind this to the current object
